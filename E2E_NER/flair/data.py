...
class Corpus:
    ...
    def make_tag_dictionary(self, tag_type: str):
        ...
        tag_capu_type = 'capu'
        tag_capu_dictionary: Dictionary = Dictionary()
        # tag_dictionary.add_item("O")
        for sentence in self.get_all_sentences():
            for token in sentence.tokens:
                tag_capu_dictionary.add_item(token.get_tag(tag_capu_type).value)
        tag_capu_dictionary.add_item("<START>")
        tag_capu_dictionary.add_item("<STOP>")


        return tag_dictionary, tag_capu_dictionary
